...
Siehe https://docs.arc42.org/section-7/[Verteilungssicht] in der online-Dokumentation.
...
image::Build-Automation.png["CI/CD Build Automatisierungs Pipeline"]

image::dev-pipeline.gif["CI/CD komplette Entwicklungs-Pipeline"]